...
Menu::Menu(sf::RenderWindow &window)
{
	...
	if (!computerpng.loadFromFile("ComputerDrawing.png")) {
	...
	optionshapes[0].setFillColor(sf::Color::Black);
	...
	optionshapes[1].setFillColor(sf::Color::Black);
	...
	optionshapes[2].setFillColor(sf::Color::Black);
...
void Menu::SelectUp()
{
	...
	{
		Options[OptionSelected].setColor(sf::Color::Red);
		OptionSelected = 2;
